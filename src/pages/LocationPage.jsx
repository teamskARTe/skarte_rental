  ...
  return (
    <section className="pt-28 md:pt-36 px-6 md:px-10 max-w-[1100px] mx-auto pb-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-line mb-16">
        {[
          { t:'송도점 — 대중교통', d:'인천지하철 1호선 센트럴파크역·인천대입구역에서 접근할 수 있습니다. 송도 BRC 스마트밸리 지식산업센터 E동으로 오신 뒤 19층 1905-A호로 이동하세요.' },
          { t:'송도점 — 자가용·주차', d:'건물 지하 주차장을 이용하실 수 있습니다. 장비 상·하차 시 1층 하역장에 정차 후 이동하시면 편리합니다.' },
